    ...
    render() {
        return (
            <View style={{marginTop: '50%', marginLeft: '8%'}}>
                ...
                <TouchableOpacity style={{paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', borderTopWidth: 1, borderBottomWidth: 1}} onPressIn={()=>{this.setState({isVisible: true, firstArgPlaceholder: 'Enter email receiver', secondArgPlaceholder: 'Enter email subject', name: 'GmailSendEmail'})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Gmail   -{'>'} Send email</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', borderTopWidth: 1, borderBottomWidth: 1}} onPressIn={()=>{this.setState({isVisible: true, firstArgPlaceholder: 'Owner of repository', secondArgPlaceholder: 'Name of repository', name: 'GithubCreateIssue'})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Github  -{'>'} Create new issue on repository</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', borderTopWidth: 1, borderBottomWidth: 1}} onPressIn={()=>{this.setState({isVisible: true, firstArgPlaceholder: 'Channel id', secondArgPlaceholder: '', name: 'DiscordMessage', isEditable: false})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Discord -{'>'} Send message in channel</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', borderTopWidth: 1, borderBottomWidth: 1}} onPressIn={()=>{this.checkReactionAndUpdate('TwitterTweet', {})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Twitter -{'>'} Post tweet</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', borderTopWidth: 1, borderBottomWidth: 1}} onPressIn={()=>{this.checkReactionAndUpdate('SpotifyNext', {})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Spotify -{'>'} Skip to the next song</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{borderTopWidth: 1, borderBottomWidth: 1, paddingTop: '2%', paddingBottom: '2%', paddingLeft: '5%'}} onPressIn={()=>{this.checkReactionAndUpdate('SpotifyPlay', {})}}>
                    <Text style={{color: 'black', fontWeight: 'normal', fontFamily: 'Palanquin-Bold'}}>Spotify -{'>'} Play song</Text>
                </TouchableOpacity>
                <Button title='Create ARea' onPressIn={this.props.onCreate}/>
                <Overlay isVisible={this.state.isVisible} onBackdropPress={()=>this.setState({isVisible: false})}>
                    ...
                    <Button title='Confirm' onPressIn={()=>{this.checkReactionAndUpdate('', {})}}/>
                    <Button title='Cancel' onPressIn={()=>{this.setState({isVisible: false, isEditable: true})}}/>
                </Overlay>
            </View>
        )
    }
